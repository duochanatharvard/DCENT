...
#SBATCH -o ${dir_log}/ICOADS_04_QC_err

matlab -nosplash -nodesktop -nodisplay -r "yr=\${SLURM_ARRAY_TASK_ID}+1849;  for mon = 1:12,  ICOADS_NC_Step_04_Buddy_check(yr,mon,${redo}); end; quit;">>${dir_log}/ICOADS_04_QC_log_\$SLURM_ARRAY_TASK_ID

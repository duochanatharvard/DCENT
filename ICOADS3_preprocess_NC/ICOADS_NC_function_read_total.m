function out = ICOADS_NC_function_read_total(yr,mon,var)
    ...
    file1 = [dir1,'ICOADS_R',ICOADS_version,'T_',...
                                               num2str(yr),'-',cmon,'.nc'];
    file2 = [dir2,'ICOADS_R',ICOADS_version,'T_',...
                                         num2str(yr),'-',cmon,'_preQC.nc'];
    file3 = [dir3,'ICOADS_R',ICOADS_version,'T_',...
                                          num2str(yr),'-',cmon,'_QCed.nc'];
    file4 = [dir4,'ICOADS_R',ICOADS_version,'T_',...

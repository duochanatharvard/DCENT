function LME_correct_2022_pattern_sum(P)
    ...
    elseif P.en > 0  % Randomized corrected temperatures
        ...
        for yr = P.yr_list
            ...
            data = load(file_load,'SST_ship',['SST_corr_rnd_',num2str(P.en)]);

            data.SST_corr_rnd = data.(['SST_corr_rnd_', num2str(P.en)]);

            corr = data.SST_corr_rnd.grp_dcd_ones_rnd + ...
                   data.SST_corr_rnd.grp_dcd_ptrn_rnd + ...
                   data.SST_corr_rnd.grp_fix_ones_rnd + ...
                   data.SST_corr_rnd.grp_fix_ptrn_rnd;
            SST_ship(:,:,:,yr_id) = data.SST_ship + corr;
